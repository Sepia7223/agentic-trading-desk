...
class JournalRecordType(StrEnum):
    ...
    STRATEGY_WALK_FORWARD_COMPLETED = "STRATEGY_WALK_FORWARD_COMPLETED"
    STRATEGY_COST_STRESS_COMPLETED = "STRATEGY_COST_STRESS_COMPLETED"
    STRATEGY_ROBUSTNESS_COMPLETED = "STRATEGY_ROBUSTNESS_COMPLETED"
    STRATEGY_PORTFOLIO_TEST_COMPLETED = "STRATEGY_PORTFOLIO_TEST_COMPLETED"
    STRATEGY_PROMOTION_DECISION_CREATED = "STRATEGY_PROMOTION_DECISION_CREATED"
    STRATEGY_PROMOTED = "STRATEGY_PROMOTED"
    STRATEGY_DISABLED = "STRATEGY_DISABLED"
    STRATEGY_CIRCUIT_BREAKER_TRIGGERED = "STRATEGY_CIRCUIT_BREAKER_TRIGGERED"
    STRATEGY_CIRCUIT_BREAKER_CLEARED = "STRATEGY_CIRCUIT_BREAKER_CLEARED"
    STRATEGY_INVALIDATION_EVALUATED = "STRATEGY_INVALIDATION_EVALUATED"
    OPPORTUNITY_CYCLE_STARTED = "OPPORTUNITY_CYCLE_STARTED"
    MARKET_UNIVERSE_LOADED = "MARKET_UNIVERSE_LOADED"
    INSTRUMENT_EVALUATED = "INSTRUMENT_EVALUATED"
    STRATEGY_EVALUATED = "STRATEGY_EVALUATED"
    OPPORTUNITY_CANDIDATE_CREATED = "OPPORTUNITY_CANDIDATE_CREATED"
    OPPORTUNITY_COST_ESTIMATED = "OPPORTUNITY_COST_ESTIMATED"
    OPPORTUNITY_SCORED = "OPPORTUNITY_SCORED"
    OPPORTUNITY_REJECTED = "OPPORTUNITY_REJECTED"
    OPPORTUNITY_DUPLICATE_SUPPRESSED = "OPPORTUNITY_DUPLICATE_SUPPRESSED"
    OPPORTUNITY_CORRELATION_REJECTED = "OPPORTUNITY_CORRELATION_REJECTED"
    OPPORTUNITY_RANKING_CREATED = "OPPORTUNITY_RANKING_CREATED"
    OPPORTUNITY_SELECTED = "OPPORTUNITY_SELECTED"
    OPPORTUNITY_RISK_SUBMITTED = "OPPORTUNITY_RISK_SUBMITTED"
    OPPORTUNITY_RISK_REJECTED = "OPPORTUNITY_RISK_REJECTED"
    OPPORTUNITY_EXECUTION_APPROVED = "OPPORTUNITY_EXECUTION_APPROVED"
    OPPORTUNITY_CYCLE_COMPLETED = "OPPORTUNITY_CYCLE_COMPLETED"
    OPPORTUNITY_CYCLE_FAILED = "OPPORTUNITY_CYCLE_FAILED"
    PORTFOLIO_BATCH_EVALUATED = "PORTFOLIO_BATCH_EVALUATED"
    PORTFOLIO_DECISION_CREATED = "PORTFOLIO_DECISION_CREATED"
    INACTIVITY_DIAGNOSTIC_CREATED = "INACTIVITY_DIAGNOSTIC_CREATED"
    DEMO_CAMPAIGN_STARTED = "DEMO_CAMPAIGN_STARTED"
    DEMO_CAMPAIGN_SNAPSHOT_CREATED = "DEMO_CAMPAIGN_SNAPSHOT_CREATED"
    DEMO_CAMPAIGN_HALTED = "DEMO_CAMPAIGN_HALTED"
