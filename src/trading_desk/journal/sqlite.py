...
_REQUIRES_PARENT = frozenset(
    {
        ...
        JournalRecordType.EXIT_DECISION,
        JournalRecordType.EXIT_PREFLIGHT,
        JournalRecordType.CLOSE_REQUEST,
        JournalRecordType.CLOSE_SUBMISSION,
        JournalRecordType.CLOSE_CONFIRMATION,
        JournalRecordType.CLOSE_RECONCILIATION,
        JournalRecordType.POSITION_CLOSED,
        JournalRecordType.POSITION_CLOSE_BLOCKED,
        JournalRecordType.POSITION_LIFECYCLE_HALTED,
        JournalRecordType.PAPER_DEMO_EXIT_COMPARISON,
